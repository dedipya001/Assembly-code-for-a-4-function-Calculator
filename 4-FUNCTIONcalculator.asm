...
.DATA
    ...
    proj  DB 0AH,0DH,   "                   ---- AN ARBITRARY PRECISION 4-FUNCTION CALCULATOR ----$" 
    team_mem  DB 0AH,0DH, "                   ---TEAM MEMBERS:---$"
    my_name1  DB 0AH,0DH, "                   ---DEDIPYA GOSWAMI | AP21110010650---$" 
    my_name2  DB 0AH,0DH, "                   ---ADNAN KHAN | AP21110011217---$" 
    my_name3  DB 0AH,0DH, "                   ---CHAITANYA TADIPINENI | AP21110010649---$"
    my_name4  DB 0AH,0DH, "                   ---PRADEEPIKA MAKKENNA | AP21110010608---$" 
    my_name5  DB 0AH,0DH, "                   ---ARDHALA RADHAKRISHNA YADAV | AP21110010609---$"
    section  DB 0AH,0DH,"                   ---------------- CSE - J -----------------$" 
    done  DB 0AH,0DH, "---------------------------------$" 
    done2  DB 0AH,0DH, "********************************************************************************$"
...
.CODE       
            ...
            LEA DX,team_mem          ;to print name string of "Team Members"
            MOV AH,09H              ;To display character string
            INT 21H                 ;call DOS function
            
            LEA DX,my_name1           ;to print name string of 1
            MOV AH,09H              ;To display character string
            INT 21H                 ;call DOS function 
            
             LEA DX,my_name2           ;to print name string of 2
            MOV AH,09H              ;To display character string
            INT 21H                 ;call DOS function
            
             LEA DX,my_name3           ;to print name string of 3
            MOV AH,09H              ;To display character string
            INT 21H                 ;call DOS function
            
             LEA DX,my_name4           ;to print name string of 4
            MOV AH,09H              ;To display character string
            INT 21H                 ;call DOS function
            
             LEA DX,my_name5           ;to print name string of 5
            MOV AH,09H              ;To display character string
            INT 21H                 ;call DOS function
